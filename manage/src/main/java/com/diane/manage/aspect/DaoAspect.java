package com.diane.manage.aspect;

import com.diane.manage.util.SecurityUtils;
import com.diane.common.utils.StringUtils;
...
public class DaoAspect {
	...
	@Pointcut("execution(* com.diane.manage.dao.*.update*(..))")
	public void daoUpdate() {
	}

	@Pointcut("execution(* com.diane.manage.dao.*.insert*(..))")
