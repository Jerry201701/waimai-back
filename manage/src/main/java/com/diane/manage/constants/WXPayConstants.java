...
public class WXPayConstants {
     ...
     * 商户号
     */
    public static final String MCH_ID = "1553040751"; // 真实
    ...
    //public static String APICLIENT_CERT = "C:\\Users\\HP\\Desktop\\api\\apiclient_cert.P12"; // 真实
    public static String APICLIENT_CERT = "/usr/local/software/cert/apiclient_cert.P12"; // 真实
